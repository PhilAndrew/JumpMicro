module jumpmicro.jmcloner.impl.idris.CallJava
...
IdrisThreadClass = Class "jumpmicro/jmcloner/impl/idris/IdrisThread"
...
ListIntClass = Class "jumpmicro/jmcloner/impl/idris/ListInt"

ListInt : Type
ListInt = JVM_Native ListIntClass

JExportTestClass : JVM_NativeTy
JExportTestClass = Class "jumpmicro/jmcloner/impl/idris/JExportTest"
...
exports1 : FFI_Export FFI_JVM "jumpmicro/jmcloner/impl/idris/IdrisThread extends java/lang/Thread implements java/lang/Runnable" []
exports1 =
  Data (List Int) "jumpmicro/jmcloner/impl/idris/ListInt" $
...
exports2 : FFI_Export FFI_JVM "jumpmicro/jmcloner/impl/idris/JExportTest" []
exports2 =
  Data (List Int) "jumpmicro/jmcloner/impl/idris/ListInt" $
