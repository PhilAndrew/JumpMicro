...
/** @constructor */
function $c_Ltestclient_TutorialApp$() {
  $c_O.call(this)
}
$c_Ltestclient_TutorialApp$.prototype = new $h_O();
$c_Ltestclient_TutorialApp$.prototype.constructor = $c_Ltestclient_TutorialApp$;
/** @constructor */
function $h_Ltestclient_TutorialApp$() {
  /*<skip>*/
}
$h_Ltestclient_TutorialApp$.prototype = $c_Ltestclient_TutorialApp$.prototype;
$c_Ltestclient_TutorialApp$.prototype.init___ = (function() {
  return this
});
$c_Ltestclient_TutorialApp$.prototype.main__V = (function() {
  $g.console.log("Hello!")
});
$c_Ltestclient_TutorialApp$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Ltestclient_TutorialApp$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Ltestclient_TutorialApp$ = new $TypeData().initClass({
  Ltestclient_TutorialApp$: 0
}, false, "testclient.TutorialApp$", {
  Ltestclient_TutorialApp$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Ltestclient_TutorialApp$.prototype.$classData = $d_Ltestclient_TutorialApp$;
var $n_Ltestclient_TutorialApp$ = (void 0);
function $m_Ltestclient_TutorialApp$() {
  if ((!$n_Ltestclient_TutorialApp$)) {
    $n_Ltestclient_TutorialApp$ = new $c_Ltestclient_TutorialApp$().init___()
  };
  return $n_Ltestclient_TutorialApp$
}
$e.testclient = ($e.testclient || {});
$e.testclient.TutorialApp = $m_Ltestclient_TutorialApp$;
/** @constructor */
...
//# sourceMappingURL=scalajsproject-fastopt.js.map
