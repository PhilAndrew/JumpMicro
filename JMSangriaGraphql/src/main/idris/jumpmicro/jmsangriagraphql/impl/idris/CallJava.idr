module jumpmicro.jmsangriagraphql.impl.idris.CallJava
...
IdrisThreadClass = Class "jumpmicro/jmsangriagraphql/impl/idris/IdrisThread"
...
ListIntClass = Class "jumpmicro/jmsangriagraphql/impl/idris/ListInt"

ListInt : Type
ListInt = JVM_Native ListIntClass

JExportTestClass : JVM_NativeTy
JExportTestClass = Class "jumpmicro/jmsangriagraphql/impl/idris/JExportTest"
...
exports1 : FFI_Export FFI_JVM "jumpmicro/jmsangriagraphql/impl/idris/IdrisThread extends java/lang/Thread implements java/lang/Runnable" []
exports1 =
  Data (List Int) "jumpmicro/jmsangriagraphql/impl/idris/ListInt" $
...
exports2 : FFI_Export FFI_JVM "jumpmicro/jmsangriagraphql/impl/idris/JExportTest" []
exports2 =
  Data (List Int) "jumpmicro/jmsangriagraphql/impl/idris/ListInt" $
